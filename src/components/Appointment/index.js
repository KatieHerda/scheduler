...
export default function Appointment(props) {
  ...
  //True - current mode reaplced, taking user directly back to show mode, instead of confirm component.
  ...
  return (
    <article className="appointment">
      ...
      {mode === CONFIRMING && (< Confirm message="Are you sure you would like to delete?" onCancel={back} onConfirm={deleteInterview}/>)}
